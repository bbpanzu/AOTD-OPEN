	 ...
	 */
        ...
        public static function construct(key:String,?_excludeArray:Array<String> = null):FlxFramesCollection{
               ...
               // heightoffset = _heightoffset;
                ...
                var animationData:AnimationData = Json.parse(AOTD.getTextFile(key + "/Animation.json"));
                var atlasData:AtlasData = Json.parse(AOTD.getTextFile(key + "/spritemap.json"));
                var bitmapData:BitmapData = AOTD.getBitmapFile(key + "/spritemap.png");
                ...
                for (i in t.getFrame(animation)...t.numFrames){
                        ...
                        if (t.currentLabel == animation){
                                if (_excludeArray.contains(animation)){
                                        ...
                                        bitmapShit.drawWithQuality(t,null,null,null,null,true,"low");
